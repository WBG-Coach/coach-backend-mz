...
/**
 * Class QuestionnaireQuestionCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class QuestionnaireQuestionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\QuestionnaireQuestion::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/questionnaire-question');
        CRUD::setEntityNameStrings('questionnaire question', 'questionnaire questions');
    }
